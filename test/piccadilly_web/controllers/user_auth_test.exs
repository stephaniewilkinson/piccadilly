defmodule PiccadillyWeb.UserAuthTest do
  use PiccadillyWeb.ConnCase, async: true

  alias Piccadilly.Accounts
  alias PiccadillyWeb.UserAuth
  import Piccadilly.AccountsFixtures

  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, PiccadillyWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_user/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      PiccadillyWeb.Endpoint.subscribe(live_socket_id)
