defmodule Piccadilly.Accounts.User do
  use Ecto.Schema
  ...
  defp validate_email(changeset) do
    ...
    |> unsafe_validate_unique(:email, Piccadilly.Repo)
  ...
  """
  def valid_password?(%Piccadilly.Accounts.User{hashed_password: hashed_password}, password)
